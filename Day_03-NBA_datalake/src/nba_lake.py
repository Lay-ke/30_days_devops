...
# AWS configurations
region = os.getenv("REGION_NAME")  # Replace with your preferred AWS region
bucket_name = os.getenv("BUCKET_NAME")  # Change to a unique S3 bucket name
glue_database_name = os.getenv("GLUE_DATABASE_NAME")  # Change to a unique Glue database name
...
def configure_athena():
    ...
    try:
        athena_client.start_query_execution(
            QueryString=f"SELECT * FROM {glue_database_name}.nba_analytics",
